<?php
include_once 'classes/view/akcioView.php';
include_once 'classes/view/kalandView.php';
include_once 'classes/view/dramaView.php';
include_once 'classes/view/horrorView.php';
include_once 'classes/view/animacioView.php';
?>
  ...
  <!-- <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <a class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
      ...
      <div class="main-container">
        <h4 class="valami">Akció</h4>
        <div class="card-deck">
          <?php
            $akcioCards = akcioView::showAkcio();
          ?>
        </div>
        ...
        <div class="card-deck">
          <?php
            $kalandCards = kalandView::showKaland();
          ?>
        </div>
      ...
      <div class="card-deck">
          <?php
            $dramaCards = dramaView::showDrama();
          ?>
      </div>
      ...
      <div class="card-deck">
          <?php
            $horrorCards = horrorView::showHorror();
          ?>
      </div>
      ...
      <div class="card-deck">
          <?php
            $animacioCards = animacioView::showAnimacio();
          ?>
      </div>
